...
from mlflow.store.model_registry.gravitino_store import GravitinoStore
from mlflow.store.model_registry.rest_store import RestStore
from mlflow.store.model_registry.tclake_store import TCLakeStore
...
def _get_store_registry():
    ...
    _model_registry_store_registry.register("tclake", TCLakeStore)
    _model_registry_store_registry.register("gravitino", GravitinoStore)
